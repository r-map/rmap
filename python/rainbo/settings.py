...
TEMPLATE_DIRECTORIES = (
    os.path.join( BASE_DIR, 'rainbo', 'templates', 'base_service' ),
    os.path.join( BASE_DIR, 'rainbo', 'templates', 'home', 'buttons' ),
    os.path.join( BASE_DIR, 'rainbo', 'templates', 'home' ),
)
...
MAINSITES=("rmapv.rmap.cc","rmap.publicwifi.it","localhost:8888")
