...
setup(name='rmap',
      ...
      packages=['rmap','rmap.stations','rmap.stations.migrations','rmap.doc','mapview','http2mqtt','registration','registration.management','registration.backends','registration.backends.default','registration.backends.simple','registration.management.commands','registration.migrations','paho','paho.mqtt','borinud','borinud.v1','borinud.utils','borinud.migrations'],
      ...
      license = "GNU GPL v2",
      install_requires= [ "django","configobj","plyer","pika","simplejson","futures","requests","pyserial","django-leaflet","django-jsonfield","django-geojson"],
