...
setup(name='rmap',
      ...
      packages=['rmap','rmap.stations','rmap.stations.migrations','rmap.doc','mapview','registration','http2mqtt','registration.management','registration.backends','registration.backends.default','registration.backends.simple','registration.management.commands','paho','paho.mqtt','borinud','borinud.v1','borinud.utils','borinud.migrations'],
