...
class createmanpages(Command):
    ...
    def run(self):
        try:
            ...
            subprocess.check_call(["help2man","-N","-o","man/man1/amqp2amqp_jsonline2bufrd.1","./amqp2amqp_jsonline2bufrd"])
            subprocess.check_call(["gzip", "-f","man/man1/amqp2amqp_jsonline2bufrd.1"])
            ...
            subprocess.check_call(["help2man","-N","--no-discard-stderr","-o","man/man1/amqp_producer.1","./amqp_producer"])
            subprocess.check_call(["gzip", "-f","man/man1/amqp_producer.1"])
