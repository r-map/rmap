...
class Firmware(models.Model):
    ...
    version = models.PositiveIntegerField(ugettext_lazy('Firmare version'),\
                    help_text=ugettext_lazy("firmware major version"))
    revision = models.PositiveIntegerField(ugettext_lazy('Firmare revision'),\
                    help_text=ugettext_lazy("firmware minor version"))
