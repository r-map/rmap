...
// increment on change
#define SOFTWARE_VERSION "2026-06-16T12:00"    // date and time iso format
#define MAJOR_VERSION    "20260616"            // date  YYYYMMDD
#define MINOR_VERSION    "1200"                   // time  HHMM without leading 0
...
#define TASK_NOW_SAT_STACK_SIZE     2000
