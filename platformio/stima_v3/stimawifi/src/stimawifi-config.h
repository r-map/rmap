...
#define DATA_BURST_RECOVERY (DATA_BURST*2)

#define DB_QUEUE_LEN (DATA_BURST)
#define MQTT_QUEUE_LEN (DATA_BURST*3)

#define MQTT_QUEUE_SPACELEFT_MEASURE (DATA_BURST*2)
#define MQTT_QUEUE_SPACELEFT_PUBLISH (DATA_BURST)
