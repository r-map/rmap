...
#ifndef _LEAF_SENSOR_TASK_H
#define _LEAF_SENSOR_TASK_H
...
#define LEAF_TASK_LOW_POWER_ENABLED       (true)
#define LEAF_TASK_SWITCH_POWER_ENABLED    (false)
#define LEAF_TASK_WAIT_DELAY_MS           (50)
#define LEAF_TASK_GENERIC_RETRY_DELAY_MS  (5000)
#define LEAF_TASK_GENERIC_RETRY           (3)

// POWER SENSOR SWITCHING OR FIXED MODE...
#if (!LEAF_TASK_SWITCH_POWER_ENABLED)
// Timing to wakeUP only internal comparator ADC
#define LEAF_TASK_POWER_ON_WAIT_DELAY_MS  (5)
#define LEAF_FIXED_POWER_CHANEL_0         (true)
#define LEAF_FIXED_POWER_CHANEL_1         (false)
#define LEAF_FIXED_POWER_CHANEL_2         (false)
#define LEAF_FIXED_POWER_CHANEL_3         (false)
#else
// Timing to wakeUP exernal sensor if automatic powered
#define LEAF_TASK_POWER_ON_WAIT_DELAY_MS  (100)
#endif
...
class LeafSensorTask : public cpp_freertos::Thread {
...
public:
  LeafSensorTask(const char *taskName, uint16_t stackSize, uint8_t priority, LeafSensorParam_t LeafSensorParam);
