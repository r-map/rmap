...
#define SOLAR_RADIATION_SENSOR_TASK_TRACE_LEVEL TRACE_LEVEL_VERBOSE
#define LEAF_SENSOR_TASK_TRACE_LEVEL            TRACE_LEVEL_VERBOSE
...
#define LEAF_SENSOR_TASK_TRACE_LEVEL TRACE_LEVEL_OFF
