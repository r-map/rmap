...
class canardClass {
    ...
    public:
        ...
        rmap_module_Leaf_1_0 module_leaf;
        ...
        class port_id
        {
            ...
            CanardPortID publisher_module_leaf;
            CanardPortID service_module_leaf;
