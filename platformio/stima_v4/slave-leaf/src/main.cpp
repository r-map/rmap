...
void setup() {
  ...
  static LeafSensorParam_t leafSensorParam = {0};
  leafSensorParam.configuration = &configuration;
  leafSensorParam.system_status = &system_status;
  leafSensorParam.configurationLock = configurationLock;
  leafSensorParam.systemStatusLock = systemStatusLock;
  leafSensorParam.systemMessageQueue = systemMessageQueue;
  leafSensorParam.elaborateDataQueue = elaborateDataQueue;
#endif
...
#if (MODULE_TYPE == STIMA_MODULE_TYPE_LEAF)
  static LeafSensorTask leaf_sensor_task("LeafTask", 350, OS_TASK_PRIORITY_03, leafSensorParam);
#endif
