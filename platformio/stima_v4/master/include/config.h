...
#define RMAP_BACKUP_DATA_LEN_TOPIC_SIZE     (40U)   // NEED TO BE >= SENSOR_TOPIC FOR MQTT
#define RMAP_BACKUP_DATA_LEN_MESSAGE_SIZE   (110U)  // NEED TO BE >= MESSAGE MQTT VALUE
