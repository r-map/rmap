...
* @retval None
*/
void HAL_ADC_MspInit_Local(ADC_HandleTypeDef* hadc)
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
...
* @retval None
*/
void HAL_ADC_MspDeInit_Local(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
...
extern "C" void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA15 (JTDI)     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_15);
