...
void setup() {
  ...
  static LevelSensorParam_t levelSensorParam = {0};
  levelSensorParam.configuration = &configuration;
  levelSensorParam.system_status = &system_status;
  levelSensorParam.configurationLock = configurationLock;
  levelSensorParam.systemStatusLock = systemStatusLock;
  levelSensorParam.systemMessageQueue = systemMessageQueue;
  levelSensorParam.elaborateDataQueue = elaborateDataQueue;
#endif
