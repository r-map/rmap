...
#ifndef _LEVEL_SENSOR_TASK_H
#define _LEVEL_SENSOR_TASK_H
...
#define LEVEL_TASK_LOW_POWER_ENABLED       (true)
#define LEVEL_TASK_SWITCH_POWER_ENABLED    (false)
#define LEVEL_TASK_WAIT_DELAY_MS           (50)
#define LEVEL_TASK_GENERIC_RETRY_DELAY_MS  (5000)
#define LEVEL_TASK_GENERIC_RETRY           (3)

// POWER SENSOR SWITCHING OR FIXED MODE...
#if (!LEVEL_TASK_SWITCH_POWER_ENABLED)
// Timing to wakeUP only internal comparator ADC
#define LEVEL_TASK_POWER_ON_WAIT_DELAY_MS  (5)
#define LEVEL_FIXED_POWER_CHANEL_0         (true)
#define LEVEL_FIXED_POWER_CHANEL_1         (false)
#define LEVEL_FIXED_POWER_CHANEL_2         (false)
#define LEVEL_FIXED_POWER_CHANEL_3         (false)
#else
// Timing to wakeUP exernal sensor if automatic powered
#define LEVEL_TASK_POWER_ON_WAIT_DELAY_MS  (100)
#endif
...
class LevelSensorTask : public cpp_freertos::Thread {
...
public:
  LevelSensorTask(const char *taskName, uint16_t stackSize, uint8_t priority, LevelSensorParam_t levelSensorParam);
...
private:
  ...
  float getLevel(float adc_value, float adc_current_min, float adc_current_max, bool *adc_overflow, float offset, float gain);
