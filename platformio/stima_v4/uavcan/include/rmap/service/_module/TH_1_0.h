...
// Source file:   C:/Dati/RMAP/stimav4-test/uavcan/data_types/rmap/service/module/TH.1.0.dsdl
// Generated at:  2022-08-05 17:04:53.795795 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "C:/Dati/RMAP/stimav4-test/uavcan/data_types/rmap/service/module/TH.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define rmap_service_module_TH_Request_1_0_EXTENT_BYTES_                    2UL
#define rmap_service_module_TH_Request_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 2UL
...
#define rmap_service_module_TH_Request_1_0_get_istant (0U)
/// saturated uint3 get_current = 1
#define rmap_service_module_TH_Request_1_0_get_current (1U)
/// saturated uint3 get_last = 2
#define rmap_service_module_TH_Request_1_0_get_last (2U)
/// saturated uint3 reset_last = 3
#define rmap_service_module_TH_Request_1_0_reset_last (3U)
/// saturated uint3 start_acq = 4
#define rmap_service_module_TH_Request_1_0_start_acq (4U)
/// saturated uint3 stop_acq = 5
#define rmap_service_module_TH_Request_1_0_stop_acq (5U)
/// saturated uint3 loop_acq = 6
#define rmap_service_module_TH_Request_1_0_loop_acq (6U)
/// saturated uint3 continuos_acq = 7
#define rmap_service_module_TH_Request_1_0_continuos_acq (7U)
/// saturated uint13 MAX = 7200
#define rmap_service_module_TH_Request_1_0_MAX (7200U)
...
typedef struct
{
    ...
    /// saturated uint13 run_for_second
    uint16_t run_for_second;
    ...
    const rmap_service_module_TH_Request_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint13 run_for_second
        uint16_t _sat1_ = obj->run_for_second;
        if (_sat1_ > 8191U)
        {
            _sat1_ = 8191U;
        }
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat1_, 13U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    rmap_service_module_TH_Request_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated uint13 run_for_second
    out_obj->run_for_second = nunavutGetU16(&buffer[0], capacity_bytes, offset_bits, 13);
    offset_bits += 13U;
...
/// instead of the extent because it provides a tighter bound of the object size; it is safe because the concrete type
/// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
#define rmap_service_module_TH_Response_1_0_EXTENT_BYTES_                    30UL
#define rmap_service_module_TH_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 30UL
    ...
    const rmap_service_module_TH_Response_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    const size_t capacity_bytes = *inout_buffer_size_bytes;
    if ((8U * (size_t) capacity_bytes) < 240UL)
    {
        return -NUNAVUT_ERROR_SERIALIZATION_BUFFER_TOO_SMALL;
    }
    // Notice that fields that are not an integer number of bytes long may overrun the space allocated for them
    ...
    {   // saturated uint8 stato
        ...
        buffer[offset_bits / 8U] = (uint8_t)(obj->stato);  // C std, 6.3.1.3 Signed and unsigned integers
        offset_bits += 8U;
    }
    ...
    {   // rmap.module.TH.1.0 dataandmetadata
        ...
        int8_t _err3_ = rmap_module_TH_1_0_serialize_(
    ...
    rmap_service_module_TH_Response_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    {
        out_obj->stato = buffer[offset_bits / 8U] & 255U;
    }
    else
    {
        out_obj->stato = 0U;
    ...
    // rmap.module.TH.1.0 dataandmetadata
    {
        ...
        const int8_t _err5_ = rmap_module_TH_1_0_deserialize_(
