...
#define NODE_SLAVE_ID     60
#define PORT_SERVICE_RMAP (PORT_RMAP_TH)
#define SUBJECTID_PUBLISH_RMAP (PORT_RMAP_TH)
...
#define SENSOR_METADATA_COUNT   4
...
#define SENSOR_METADATA_LEVEL_P_IND_ITH   254
#define SENSOR_METADATA_LEVEL_P_IND_NTH   3
#define SENSOR_METADATA_LEVEL_P_IND_MTH   0
#define SENSOR_METADATA_LEVEL_P_IND_XTH   2
