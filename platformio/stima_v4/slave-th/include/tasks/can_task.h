...
private:
  ...
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_module_TH_1_0 *local_data);
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_service_module_TH_Response_1_0 *rmap_data);
