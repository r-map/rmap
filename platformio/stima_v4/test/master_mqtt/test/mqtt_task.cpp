...
// ************************************************************************
// ******************* TEST MQTT FUNCTION DECLARATIONS ********************
// ************************************************************************

void test_connect_mqtt_server(void);
void test_connect_mqtt_server_subscribed(void);
void test_init_mqtt_client_cyclone(void);
void test_mqtt_data_connection_sequence(void);
void test_mqtt_data_publish_disconnection_message(void);
void test_mqtt_data_publish(void);
void test_requested_queue_do_mqtt_connection_start(void);
void test_requested_resolve_name_server_mqtt(void);

// ************************************************************************
// ******************* TEST MQTT FUNCTION IMPLEMENTATIONS *****************
// ************************************************************************

/**
 * @brief TEST: Connection MQTT server
 *
 */
void test_connect_mqtt_server() {
    TEST_ASSERT_EQUAL(false, error);
}

/**
 * @brief TEST: Connection MQTT server subscribed
 *
 */
void test_connect_mqtt_server_subscribed() {
    TEST_ASSERT_EQUAL(true, is_subscribed);
}

/**
 * @brief TEST: Initialization MQTT client Cyclone
 *
 */
void test_init_mqtt_client_cyclone() {
    TEST_ASSERT_EQUAL(false, error);
}

/**
 * @brief TEST: MQTT data connection sequence
 *
 */
void test_mqtt_data_connection_sequence() {
    TEST_ASSERT_EQUAL(false, is_error);
}

/**
 * @brief TEST: MQTT data publish disconnection message
 *
 */
void test_mqtt_data_publish_disconnection_message() {
    TEST_ASSERT_EQUAL(true, !error);
}

/**
 * @brief TEST: MQTT data publish
 *
 */
void test_mqtt_data_publish() {
    TEST_ASSERT_EQUAL(false, error);
}

/**
 * @brief TEST: Request queue do MQTT connection starting
 *
 */
void test_requested_queue_do_mqtt_connection_start() {
    TEST_ASSERT_TRUE(true);
}

/**
 * @brief TEST: Request resolve name server MQTT
 *
 */
void test_requested_resolve_name_server_mqtt() {
    TEST_ASSERT_EQUAL(false, error);
}
    ...
    while (true) {
        switch (state) {
            ...
            case MQTT_STATE_WAIT_NET_EVENT:
                ...
                if (param.connectionRequestQueue->Peek(&connection_request, portMAX_DELAY)) {
                    ...
                    if (connection_request.do_mqtt_connect) {
                        RUN_TEST(test_requested_queue_do_mqtt_connection_start);
            ...
            case MQTT_STATE_CONNECT:
                ...
                RUN_TEST(test_init_mqtt_client_cyclone);
                ...
                RUN_TEST(test_requested_resolve_name_server_mqtt);
                ...
                RUN_TEST(test_connect_mqtt_server);
                ...
                RUN_TEST(test_connect_mqtt_server_subscribed);
            ...
            case MQTT_STATE_PUBLISH:
                ...
                if (param.system_status->connection.mqtt_data_published == 0) {
                    ...
                    RUN_TEST(test_mqtt_data_publish);
            ...
            case MQTT_STATE_DISCONNECT:
                ...
                RUN_TEST(test_mqtt_data_connection_sequence);
                ...
                RUN_TEST(test_mqtt_data_publish_disconnection_message);
