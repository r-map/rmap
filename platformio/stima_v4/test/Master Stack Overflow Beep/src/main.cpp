...
void setup() {
  ...
  // ***** TEST *****
  // Reducing from 600 TO 200 CAUSE AN ERROR STACK OFERVLOW AND SIGNAL FROM BUZZER 2 BEEP REPETED  
  // static SupervisorTask supervisor_task("SupervisorTask", 600, OS_TASK_PRIORITY_02, supervisorParam);
  static SupervisorTask supervisor_task("SupervisorTask", 200, OS_TASK_PRIORITY_02, supervisorParam);
