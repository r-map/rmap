...
// ************************************************************************
// ******************* TEST LCD FUNCTION DECLARATIONS *********************
// ************************************************************************

void test_display_print_hello_world(void);


// ************************************************************************
// ******************* TEST LCD FUNCTION IMPLEMENTATIONS ******************
// ************************************************************************

/**
 * @brief TEST: Display print hello world
 * 
 */
void test_display_print_hello_world() {
        ...
        if (!data_printed) {
          ...
          switch (stima4_menu_ui) {
            case MAIN: {
              ...
              RUN_TEST(test_display_print_hello_world);
