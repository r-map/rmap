...
extern "C" void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(STB_CAN_GPIO_Port, STB_CAN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(EN_CAN_GPIO_Port, EN_CAN_Pin);
  ...
  GPIO_InitStruct.Pin = LL_GPIO_PIN_0|LL_GPIO_PIN_1|LL_GPIO_PIN_2|LL_GPIO_PIN_4
                          |LL_GPIO_PIN_5|LL_GPIO_PIN_8|LL_GPIO_PIN_11|LL_GPIO_PIN_12
                          |LL_GPIO_PIN_15;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LL_GPIO_PIN_10|LL_GPIO_PIN_14|LL_GPIO_PIN_4
  ...
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(STB_CAN_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(EN_CAN_GPIO_Port, &GPIO_InitStruct);
