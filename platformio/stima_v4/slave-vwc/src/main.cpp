...
void setup() {
  ...
  static SoilVWCSensorParam_t soilVWCSensorParam = {0};
  soilVWCSensorParam.configuration = &configuration;
  soilVWCSensorParam.system_status = &system_status;
  soilVWCSensorParam.configurationLock = configurationLock;
  soilVWCSensorParam.systemStatusLock = systemStatusLock;
  soilVWCSensorParam.systemMessageQueue = systemMessageQueue;
  soilVWCSensorParam.elaborateDataQueue = elaborateDataQueue;
#endif
...
#if (MODULE_TYPE == STIMA_MODULE_TYPE_VWC)
  static SoilVWCSensorTask soil_vwc_sensor_task("VWCTask", 350, OS_TASK_PRIORITY_03, soilVWCSensorParam);
#endif
