...
typedef struct
{
   ...
   struct
   {
     ...
     #endif
     bool is_adc_unit_error;        //!< Adc unit error
     bool is_adc_unit_overflow;     //!< Adc unit overflow
   } events;
...
typedef struct
{
   rmapdata_t avg1;        //!< Measure for VWC input chanel 1
   rmapdata_t quality1;    //!< Quality of measure for VWC input chanel 1
   rmapdata_t avg2;        //!< Measure for VWC input chanel 1
   rmapdata_t quality2;    //!< Quality of measure for VWC input chanel 2
   rmapdata_t avg3;        //!< Measure for VWC input chanel 3
   rmapdata_t quality3;    //!< Quality of measure for VWC input chanel 3
} report_t;
