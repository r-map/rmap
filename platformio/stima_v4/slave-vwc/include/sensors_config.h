...
/*!
\def USE_SENSOR_SWC1
\brief Enable if you want use soil vwc(1..4) sensor.
*/
#define USE_SENSOR_SWC1             (true)
#define USE_SENSOR_SWC2             (true)
#define USE_SENSOR_SWC3             (true)
#define USE_SENSOR_SWC4             (false)
...
#define USE_SOIL_VWC_SENSORS                  (USE_SENSOR_SWC1 + USE_SENSOR_SWC2 + USE_SENSOR_SWC3 + USE_SENSOR_SWC4)
...
#elif (USE_SOIL_VWC_SENSORS)
#define USE_MODULE_SOIL_VWC                   (true)
#define SENSORS_COUNT_MAX                     (USE_SOIL_VWC_SENSORS)
#endif
