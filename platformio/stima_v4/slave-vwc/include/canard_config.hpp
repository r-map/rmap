...
#define NODE_SLAVE_ID     65
#define PORT_SERVICE_RMAP (PORT_RMAP_VWC)
#define SUBJECTID_PUBLISH_RMAP (PORT_RMAP_VWC)
...
#define SENSOR_METADATA_COUNT   3
// METADATA DEFAULT VALUE REGISTER INIT (P_IND, P1, P2 / TYPE_1, L1, TYPE_2, L2)
#define SENSOR_METADATA_LEVEL_1_VWC1      250
#define SENSOR_METADATA_LEVEL_1_VWC2      450
#define SENSOR_METADATA_LEVEL_1_VWC3      700
#define SENSOR_METADATA_LEVEL_2           65535
#define SENSOR_METADATA_LEVELTYPE_1       106
#define SENSOR_METADATA_LEVELTYPE_2       65535
#define SENSOR_METADATA_LEVEL_P1          0
#define SENSOR_METADATA_LEVEL_P_IND_VWC1  0
#define SENSOR_METADATA_LEVEL_P_IND_VWC2  0
#define SENSOR_METADATA_LEVEL_P_IND_VWC3  0
