            ...
            case CAN_STATE_INIT:
                ...
                clCanard.port_id.publisher_module_solar_radiation =
                    getModeAccessID(canardClass::Introspection_Port::PublisherSubjectID,
                        "RAD.data_and_metadata", rmap_module_Radiation_1_0_FULL_NAME_AND_VERSION_);
                #endif
                ...
                clCanard.port_id.service_module_solar_radiation =
                    getModeAccessID(canardClass::Introspection_Port::ServicePortID,
                        "RAD.service_data_and_metadata", rmap_service_module_Radiation_1_0_FULL_NAME_AND_VERSION_);
                #endif
                ...
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Level.L1", &val);
                localRegisterAccessLock->Give();
                ...
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Level.L2", &val);
                localRegisterAccessLock->Give();
                LOCAL_ASSERT(uavcan_register_Value_1_0_is_natural16_(&val) && (val.natural16.value.count == SENSOR_METADATA_COUNT));
                ...
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Level.LevelType1", &val);
                localRegisterAccessLock->Give();
                LOCAL_ASSERT(uavcan_register_Value_1_0_is_natural16_(&val) && (val.natural16.value.count == SENSOR_METADATA_COUNT));
                ...
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Level.LevelType2", &val);
                localRegisterAccessLock->Give();
                LOCAL_ASSERT(uavcan_register_Value_1_0_is_natural16_(&val) && (val.natural16.value.count == SENSOR_METADATA_COUNT));
                ...
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Timerange.P1", &val);
                localRegisterAccessLock->Give();
                LOCAL_ASSERT(uavcan_register_Value_1_0_is_natural16_(&val) && (val.natural16.value.count == SENSOR_METADATA_COUNT));
                ...
                val.natural16.value.elements[SENSOR_METADATA_DSA] = SENSOR_METADATA_LEVEL_P_IND_DSA;
                localRegisterAccessLock->Take();
                localRegister->read("rmap.module.RAD.metadata.Timerange.Pindicator", &val);
                localRegisterAccessLock->Give();
