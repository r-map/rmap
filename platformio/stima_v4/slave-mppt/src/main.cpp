...
void setup() {
  ...
  // LTC4015 Istance Mppt
  static Mppt mpptIC(&Wire, wireLock);
  ...
  static MpptSensorParam_t mpptSensorParam = {0};
  mpptSensorParam.configuration = &configuration;
  mpptSensorParam.system_status = &system_status;
  mpptSensorParam.configurationLock = configurationLock;
  mpptSensorParam.systemStatusLock = systemStatusLock;
  mpptSensorParam.systemMessageQueue = systemMessageQueue;
  mpptSensorParam.elaborataDataQueue = elaborataDataQueue;
  mpptSensorParam.mpptIC = &mpptIC;
#endif
...
#if (MODULE_TYPE == STIMA_MODULE_TYPE_POWER_MPPT)
  static MpptSensorTask mppt_sensor_task("MpptTask", 350, OS_TASK_PRIORITY_03, mpptSensorParam);
#endif
