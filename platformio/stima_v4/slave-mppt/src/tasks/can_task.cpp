            ...
            case CAN_STATE_INIT:
                ...
                clCanard.port_id.publisher_module_mppt =
                    getModeAccessID(canardClass::Introspection_Port::PublisherSubjectID,
                        REGISTER_DATA_PUBLISH, rmap_module_Power_1_0_FULL_NAME_AND_VERSION_);
                #endif
                ...
                clCanard.port_id.service_module_mppt =
                    getModeAccessID(canardClass::Introspection_Port::ServicePortID,
                        REGISTER_DATA_SERVICE, rmap_service_module_Power_1_0_FULL_NAME_AND_VERSION_);
                #endif
                ...
                if(clCanard.port_id.service_module_mppt != UINT16_MAX)
