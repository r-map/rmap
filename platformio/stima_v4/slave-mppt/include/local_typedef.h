...
typedef struct
{
   ...
   struct
   {
     ...
     #endif
     bool is_ltc_unit_error;        //!< LTC module error
     bool is_power_full;            //!< Power full flag
     bool is_power_warning;         //!< Power warning flag
     bool is_power_critical;        //!< Power critical flag
   } events;
...
typedef struct
{
   rmapdata_t avg_battery_charge;            //!< Measure of charge battery %
   rmapdata_t avg_battery_charge_quality;    //!< Quality of measure charge battery %
   rmapdata_t avg_battery_current;           //!< Measure of istant charge current
   rmapdata_t avg_battery_current_quality;   //!< Quality of measure charge current
   rmapdata_t avg_input_voltage;             //!< Measure of istant input voltage
   rmapdata_t avg_input_voltage_quality;     //!< Quality of measure input voltage
} report_t;
