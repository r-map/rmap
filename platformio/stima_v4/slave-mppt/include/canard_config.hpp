...
#define NODE_SLAVE_ID     64
#define PORT_SERVICE_RMAP (PORT_RMAP_MPPT)
#define SUBJECTID_PUBLISH_RMAP (PORT_RMAP_MPPT)
...
#define SENSOR_METADATA_LEVEL_1           1
#define SENSOR_METADATA_LEVEL_2           65535
#define SENSOR_METADATA_LEVELTYPE_1       265
#define SENSOR_METADATA_LEVELTYPE_2       65535
#define SENSOR_METADATA_LEVEL_P1          0
#define SENSOR_METADATA_LEVEL_P_IND_MPP   0
