...
private:
  ...
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_module_Power_1_0 *rmap_data);
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_service_module_Power_Response_1_0 *rmap_data);
  ...
  static rmap_service_module_Power_Response_1_0 processRequestGetModuleData(canardClass &clsCanard, rmap_service_module_Power_Request_1_0* req, CanParam_t *param);
