...
rmap_service_module_Wind_Response_1_0 CanTask::processRequestGetModuleData(canardClass &clCanard, rmap_service_module_Wind_Request_1_0* req, CanParam_t *param) {
    ...
    switch (req->parameter.command) {
        ...
        case rmap_service_setmode_1_0_get_last:     // saturated uint3 get_last = 2
          ...
          resp.is_windsonic_axis_error = param->system_status->events.is_windsonic_axis_error;
          resp.is_windsonic_hardware_error = param->system_status->events.is_windsonic_hardware_error;
          resp.is_windsonic_crc_error = param->system_status->events.is_windsonic_crc_error;
    ...
    while (true) {
        ...
        switch (state) {
            ...
            case CAN_STATE_INIT:
                ...
                if(clCanard.port_id.service_module_wind != UINT16_MAX)
