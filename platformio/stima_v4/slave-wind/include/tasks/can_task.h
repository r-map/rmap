...
private:
  ...
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_module_Wind_1_0 *local_data);
  static void prepareSensorsDataValue(uint8_t const sensore, const report_t *report, rmap_service_module_Wind_Response_1_0 *rmap_data);
  ...
  static rmap_service_module_Wind_Response_1_0 processRequestGetModuleData(canardClass &clsCanard, rmap_service_module_Wind_Request_1_0* req, CanParam_t *param);
