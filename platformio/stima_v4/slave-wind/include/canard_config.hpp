...
#define NODE_SLAVE_ID     62
#define PORT_SERVICE_RMAP (PORT_RMAP_WIND)
#define SUBJECTID_PUBLISH_RMAP (PORT_RMAP_WIND)
...
#define SENSOR_METADATA_LEVEL_P_IND_DWA   254
#define SENSOR_METADATA_LEVEL_P_IND_DWB   200
#define SENSOR_METADATA_LEVEL_P_IND_DWC   2
#define SENSOR_METADATA_LEVEL_P_IND_DWD   0
#define SENSOR_METADATA_LEVEL_P_IND_DWE   9
#define SENSOR_METADATA_LEVEL_P_IND_DWF   205
