...
class canardClass {
    ...
    public:
        ...
        rmap_module_Wind_1_0 module_wind;
        ...
        class port_id
        {
            ...
            CanardPortID publisher_module_wind;
            CanardPortID service_module_wind;
