...
void getStimaLcdDescriptionByType(char *lcd_description_A, char* lcd_description_B, char* lcd_description_C, uint8_t type) {
  switch (type) {
    ...
    case STIMA_MODULE_TYPE_WIND:
      strncpy(lcd_description_A, STIMA_LCD_DESCRIPTION_WIND_SPEED, STIMA_LCD_DESCRIPTION_LENGTH);
      strncpy(lcd_description_B, STIMA_LCD_DESCRIPTION_WIND_DIRECTION, STIMA_LCD_DESCRIPTION_LENGTH);
      break;
...
void getStimaLcdUnitTypeByType(char *lcd_unit_type_A, char *lcd_unit_type_B, char *lcd_unit_type_C, uint8_t type) {
  switch (type) {
    ...
    case STIMA_MODULE_TYPE_WIND:
      ...
      strncpy(lcd_unit_type_B, STIMA_LCD_UNIT_TYPE_DEGREES, STIMA_LCD_UNIT_TYPE_LENGTH);
      break;
