...
// Generated at:  2023-02-13 19:08:41.564457 UTC
// Is deprecated: no
// Fixed port-ID: None
...
/// instead of the extent because it provides a tighter bound of the object size; it is safe because the concrete type
/// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
#define rmap_service_module_VWC_Response_1_0_EXTENT_BYTES_                    19UL
#define rmap_service_module_VWC_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 19UL
    ...
    const rmap_service_module_VWC_Response_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // rmap.sensors.VWC.1.0 VWC
        ...
        int8_t _err6_ = rmap_sensors_VWC_1_0_serialize_(
    ...
    rmap_service_module_VWC_Response_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // rmap.sensors.VWC.1.0 VWC
    {
        ...
        const int8_t _err8_ = rmap_sensors_VWC_1_0_deserialize_(
