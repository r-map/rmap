...
#define MEM_TRACE_LEVEL          TRACE_LEVEL_VERBOSE
#define NIC_TRACE_LEVEL          TRACE_LEVEL_VERBOSE
#define ETH_TRACE_LEVEL          TRACE_LEVEL_OFF
#define LLDP_TRACE_LEVEL         TRACE_LEVEL_OFF
#define ARP_TRACE_LEVEL          TRACE_LEVEL_OFF
#define IP_TRACE_LEVEL           TRACE_LEVEL_VERBOSE
#define IPV4_TRACE_LEVEL         TRACE_LEVEL_VERBOSE
...
#define PPP_TRACE_LEVEL          TRACE_LEVEL_VERBOSE
