...
#ifndef REG_RMAP_METADATA_LEVEL_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/pat1/git/Cyphal-demos/submodules/public_regulated_data_types/reg/rmap/metadata/Level.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define reg_rmap_metadata_Level_1_0_HAS_FIXED_PORT_ID_ false

#define reg_rmap_metadata_Level_1_0_FULL_NAME_             "reg.rmap.metadata.Level"
#define reg_rmap_metadata_Level_1_0_FULL_NAME_AND_VERSION_ "reg.rmap.metadata.Level.1.0"
...
///                 @see reg_rmap_metadata_Level_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t reg_rmap_metadata_Level_1_0_serialize_(
    const reg_rmap_metadata_Level_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t reg_rmap_metadata_Level_1_0_deserialize_(
    reg_rmap_metadata_Level_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void reg_rmap_metadata_Level_1_0_initialize_(reg_rmap_metadata_Level_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = reg_rmap_metadata_Level_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // REG_RMAP_METADATA_LEVEL_1_0_INCLUDED_
