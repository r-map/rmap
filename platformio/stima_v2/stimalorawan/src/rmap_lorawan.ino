...
void sleep_mgr_sensors() {
  ...
  /*
    ...
    TODO reimplement addsleepedtime in hal library of lmic
    to take in account time elapsed to sleep
    this was introduced in arduino lmic but not present in
    platformio library
    
    
    substitute micros()  with totalmicros()
