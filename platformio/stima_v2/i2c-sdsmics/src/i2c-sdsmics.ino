...
void loop() {
  ...
  if (cbpm2560n.getSize() == cbpm2560n.getCapacity()){
    ...
    for (i=0 ; i < cbpm2560n.getCapacity() ; i++){
      i2c_dataset1->pm.minpm25 = min(cbpm2560n.peek(i), (int)i2c_dataset1->pm.minpm25);
    }
  ...
  if (cbpm2560x.getSize() == cbpm2560x.getCapacity()){
    ...
    for (i=0 ; i < cbpm2560x.getCapacity() ; i++){
      i2c_dataset1->pm.maxpm25 = max(cbpm2560x.peek(i), (int)i2c_dataset1->pm.maxpm25);
    }
  }else{
  ...
  if (cbpm1060n.getSize() == cbpm1060n.getCapacity()){
    ...
    for (i=0 ; i < cbpm1060n.getCapacity() ; i++){
      i2c_dataset1->pm.minpm10 = min(cbpm1060n.peek(i), (int)i2c_dataset1->pm.minpm10);
    }
  }else{
  ...
  if (cbpm1060x.getSize() == cbpm1060x.getCapacity()){
    ...
    for (i=0 ; i < cbpm1060x.getCapacity() ; i++){
      i2c_dataset1->pm.maxpm10 = max(cbpm1060x.peek(i), (int)i2c_dataset1->pm.maxpm10);
    }
  }else{
  ...
  if (cbco60n.getSize() == cbco60n.getCapacity()){
    ...
    for (i=0 ; i < cbco60n.getCapacity() ; i++){
      i2c_dataset1->cono2.minco = min(cbco60n.peek(i), (int)i2c_dataset1->cono2.minco);
    }
  ...
  if (cbco60x.getSize() == cbco60x.getCapacity()){
    ...
    for (i=0 ; i < cbco60x.getCapacity() ; i++){
      i2c_dataset1->cono2.maxco = max(cbco60x.peek(i), (int)i2c_dataset1->cono2.maxco);
    }
  }else{
  ...
  if (cbno260n.getSize() == cbno260n.getCapacity()){
    ...
    for (i=0 ; i < cbno260n.getCapacity() ; i++){
      i2c_dataset1->cono2.minno2 = min(cbno260n.peek(i), (int)i2c_dataset1->cono2.minno2);
    }
  }else{
  ...
  if (cbno260x.getSize() == cbno260x.getCapacity()){
    ...
    for (i=0 ; i < cbno260x.getCapacity() ; i++){
      i2c_dataset1->cono2.maxno2 = max(cbno260x.peek(i), (int)i2c_dataset1->cono2.maxno2);
    }
  }else{
