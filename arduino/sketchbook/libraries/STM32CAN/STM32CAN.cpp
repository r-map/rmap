...
/* Init and start CAN */
void stm32Can::begin( int baudrate, bool loopBack, bool UseAltPins ) {
    init( n_pCanHandle, baudrate, loopBack, UseAltPins );
}

/* Init and start CAN */
void stm32Can::init( CAN_HandleTypeDef* CanHandle, int baudrate, bool loopBack, bool UseAltPins ) {
