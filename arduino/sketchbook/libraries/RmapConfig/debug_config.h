...
/*!
\def ADS1115_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-gas sketch.
*/
#define ADS1115_SERIAL_TRACE_LEVEL        (SERIAL_TRACE_LEVEL_OFF)
...
/*!
\def I2C_THR_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-th sketch.
*/
#define I2C_THR_SERIAL_TRACE_LEVEL        (SERIAL_TRACE_LEVEL_INFO)
...
*/
#define I2C_OPC_SERIAL_TRACE_LEVEL        (SERIAL_TRACE_LEVEL_INFO)

/*!
\def I2C_WIND_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-wind sketch.
*/
#define I2C_WIND_SERIAL_TRACE_LEVEL       (SERIAL_TRACE_LEVEL_INFO)

/*!
\def I2C_RADIATION_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-radiation sketch.
*/
#define I2C_RADIATION_SERIAL_TRACE_LEVEL  (SERIAL_TRACE_LEVEL_INFO)

/*!
\def I2C_LEAF_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-leaf sketch.
*/
#define I2C_LEAF_SERIAL_TRACE_LEVEL       (SERIAL_TRACE_LEVEL_INFO)

/*!
\def I2C_GAS_SERIAL_TRACE_LEVEL
\brief Serial trace level debug for i2c-gas sketch.
*/
#define I2C_GAS_SERIAL_TRACE_LEVEL        (SERIAL_TRACE_LEVEL_INFO)
...
*/
#define STIMA_LCD_TRACE_LEVEL             (SERIAL_TRACE_LEVEL_INFO)
