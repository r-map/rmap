...
const char INTL_LONGITUDE[] PROGMEM = "Longitudine, sessadecinale con 5 decimali senza il punto "; 
const char INTL_LATITUDE[] PROGMEM = "Latitudine, sessadecinale con 5 decimali senza il punto "; 
