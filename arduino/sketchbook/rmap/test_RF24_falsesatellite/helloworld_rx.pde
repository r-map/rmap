...
/*
Board	          int.0	    int.1     int.4	int.2	int.3	int.4	int.5
Uno, Ethernet	      2 	3	 	 	 	 
...
int freeRam ()
{
  //Serial.println(__malloc_margin);
...
//  network.sleep(interu,LOW,SLEEP_MODE_PWR_DOWN);
  ...
  while ( network.available() ){
    ...
    if (size >0){
      ...
      if (strcmp(buffer,"{\"jsonrpc\":\"2.0\",\"method\":\"prepare\",\"params\":{\"type\":\"TMP\",\"address\":72},\"id\":0}") == 0){
       	strcpy(buffer,"{\"jsonrpc\": \"2.0\",\"result\":{\"waittime\":250},\"id\":0}\0");	
      } else if (strcmp(buffer, "{\"jsonrpc\":\"2.0\",\"method\":\"getvalues\",\"params\":{\"type\":\"TMP\",\"address\":72},\"id\":0}") == 0){
	strcpy(buffer,"{\"jsonrpc\": \"2.0\",\"result\":{\"B12101\":29802,\"B12102\":85},\"id\":0}\0");
      } else {
